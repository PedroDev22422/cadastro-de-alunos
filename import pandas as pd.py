...
def buscar_aluno(df, termo_busca):
    ...
    try:
        # 1. Tenta buscar por Matrícula (tratada como int)
        ...
        # 2. Se a conversão para int falhar, busca por Nome (case-insensitive)
...
def editar_aluno(df, index_iloc, dados_aluno):
    ...
    # O .loc[index_iloc, campo_a_editar] acessa a célula específica para edição
...
def menu_principal():
    ...
    """
    # 1. Carrega os dados existentes (ou cria um DF novo) ao iniciar o programa
